...
export default async function DashboardPage() {
  ...
  const [
    ...
    prisma.aluno.count({ where: { ativo: true, planoTipo: { in: ["Mentoria da Posse", "Mentoria Diamante"] }, contatos: { none: {} } } }),
  ...
  const cardsResumo = [
    ...
    { label: "Sem contato — Mentorias", value: semContato, color: "bg-yellow-50 text-yellow-700", border: "border-yellow-200", href: `/alunos?filtro=sem_contato&planoTipo=${encodeURIComponent("Mentoria da Posse,Mentoria Diamante")}` },
  ];
