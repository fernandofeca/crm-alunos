...
export default async function DashboardPage() {
  ...
  const cardsResumo = [
    ...
    { label: "Sem contato — Mentoria da Posse", value: semContato, color: "bg-yellow-50 text-yellow-700", border: "border-yellow-200", href: `/alunos?filtro=sem_contato&planoTipo=${encodeURIComponent("Mentoria da Posse")}` },
  ];
